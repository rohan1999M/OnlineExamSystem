...
id = 0
# names related to ids: The names associated to the ids: 1 for Person1, 2 for person2 , etc...
names = ['None',"Rohan","rohit"] # add a name into this list
#Video Capture
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if (confidence < 100):
            ...
            option=int(input(" Enter 1 for run server \n Enter ctrl + c To stop program\n"))
            if option==1:
            ...
            #os.system("python face_taker.py"),
